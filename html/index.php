 ...
 * - add cookies control for new events in authors pages
      ...
      <div class="mb-4">
        <div class="card mb-4 border-0 shadow-sm overflow-hidden">
          <div class="card-body">
            ...
            <p>Мы объединяем и поддерживаем всех, кто желает делиться своим творчеством и ищет единомышленников. Проект открыт и для начинающих, и для опытных авторов. <a href="/about">Присоединяйтесь</a>!</p>
          </div>
        </div>
      </div>
